...
本系统包含两个完全独立、并行的全自动资讯内参推送模块，均通过 GitHub Actions 免费云端调度，每天早晨准时送达，全程 0 成本运行：

---

## 🛢️ 模块一：原油化工每日早报 (每日 07:00 晨间推送 / 专属频道：`yuanyou123456`)

每天在北京时间 **07:00** 自动抓取并提炼：
- 📈 **隔夜与实时盘面**：毫秒级提取国际 WTI 原油、布伦特原油、美天然气、汽油期货最新现价、日内与隔夜涨跌幅（%）；
- ⚡ **权威多源情报**：路透/彭博能源动态、OilPrice 全球能源、CNBC Energy、化工工程在线、国内大宗商品/聚酯/聚烯烃开工；
- 🤖 **专业深度研判**：大模型深入剖析地缘溢价（中东/红海）、OPEC+决议、EIA/API库存、中下游石化裂解利润与今日开盘支撑阻力；
- 👓 **无障碍阅读优化**：顶部【大字号 10 秒总结】+ 底部【纯文字详细事实，无外链，小一号字体排版】，支持底部 K 线按钮。
...
## 🇺🇸 模块二：美国核心动态早报 (每日 06:30 晨间推送 / 专属频道：`amenews123138`)

每天在北京时间 **06:30** 自动抓取美国最新**宏观经济、政治外交、军事防务**权威资讯，通过谷歌大模型进行深度提炼分析，自动推送到你的专属频道：**`amenews123138`**。
